...
public class ConfigFileAnnotationTest {
	...
	@Test
	public void shouldCreateMapOfConfigurations() throws JsonParseException, JsonMappingException, IOException {
		...
		SimpleBakedConfiguration baked = (SimpleBakedConfiguration) configs.get(SimpleBakedConfiguration.class);
		assertThat(baked.getNick().getFirst()).isEqualTo("Nick");
		assertThat(baked.getNick().getLast()).isEqualTo("Klauer");
		assertThat(baked.getNick().getDescription()).isEqualTo("An Amazing Guy");
