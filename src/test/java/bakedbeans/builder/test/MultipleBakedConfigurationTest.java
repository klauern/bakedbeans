...
public class MultipleBakedConfigurationTest {
	...
	@Test
	public void shouldMapMultipleElementsInAYAML() throws JsonParseException, JsonMappingException, IOException {
	...
	@Test
	public void shouldCreateEdwardAndNick() throws JsonParseException, JsonMappingException, IOException {
		Map<Class, Configuration> configs = registry.mapBakedBeans();
		MultipleBakedConfiguration ed_and_nick = (MultipleBakedConfiguration) configs.get(MultipleBakedConfiguration.class);
